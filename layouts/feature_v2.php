...
<div class="top-feature-row">
    <h1 class="fes-title" style="font-family: 'Ubuntu', sans-serif;"><svg class="pinna" aria-hidden="true"><use xlink:href="#anchor"/></svg> <?php echo akina_option('feature_title', '�۽�'); ?></h1>
