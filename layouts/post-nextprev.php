...
<section class="post-squares nextprev">
	...
	if(is_array($prev_img)){$prev_lazyload=$prev_img[0];$prev_img_url=$prev_img[1];}else{$prev_lazyload=$lazyload;$prev_img_url=$prev_img;} ?>
	...
	if(is_array($next_img)){$next_lazyload=$next_img[0];$next_img_url=$next_img[1];}else{$next_lazyload=$lazyload;$next_img_url=$next_img;}?>
