...
?>
	<section class="author-profile">
		...
		<hr>
		<p><svg class="pen"><use xlink:href="#pen"/></svg><?php echo get_the_author_meta( 'description' ) ? get_the_author_meta( 'description' ) :akina_option('admin_des', 'Carpe Diem and Do what I like'); ?></p>
	</section>
