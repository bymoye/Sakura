...
?>
	...
	<section id="comments" class="comments">
		...
		<div class="commentwrap comments-hidden">
			<div class="notification"><i class="post_icon_svg svg_message"></i><?php _e('view comments', 'sakura'); /*查看评论*/?> -
			 ...
			 <?php else : ?>
				...
				<?php if(comments_open()): ?>
					<div class="commentwrap">
						<div class="notification-hidden"><i class="post_icon_svg svg_message"></i><?php _e('no comment', 'sakura'); /*暂无评论*/?></div>
			...
			<?php
				...
				if(comments_open()){
                    ...
                    $args = [
						...
						'id_submit' => 'submit',
						'title_reply' => '',
						'title_reply_to' => '<div class="graybar"><i class="post_icon_svg svg_comments-o"></i>' . __('Leave a Reply to', 'sakura') . ' %s' . '</div>',
						'cancel_reply_link' => __('Cancel Reply', 'sakura'),
						'label_submit' => __('BiuBiuBiu~', 'sakura'),
						'comment_field' => '<p><i class="post_icon_svg svg_markdown"></i>Markdown Supported while <i class="post_icon_svg svg_code"></i>Forbidden</p><div class="comment-textarea"><textarea placeholder="' . __("You are a surprise that I will only meet once in my life", "sakura") . ' ..." name="comment" class="commentbody" id="comment" rows="5" tabindex="4"></textarea><label class="input-label">' . __("You are a surprise that I will only meet once in my life", "sakura") . ' ...</label></div>
						...
						'fields' => apply_filters( 'comment_form_default_fields', [
                            'avatar' => '<div class="cmt-info-container"><div class="comment-user-avatar"><img src="https://sdn.geekzu.org/avatar/f11f237b3de93c93b24045e71f7f65c6?s=80&d=mm&r=g"><div class="socila-check qq-check"><div class="socila-check-qq"></div></div><div class="socila-check gravatar-check"><div class="socila-check-google"></div></div></div>',
							'author' =>
