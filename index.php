...
?>
   ...
   <?php if ( akina_option('head_notice') != '0'){ 
	...
	<div class="notice" style="margin-top:60px">
	   <svg class="fire"><use xlink:href="#notification"></use></svg>
	...
	<div id="primary" class="content-area">
		...
		<h1 class="main-title" style="font-family: 'Ubuntu', sans-serif;"><svg class="pinna" aria-hidden="true"><use xlink:href="#pinna"/></svg> Discovery</h1>
		<?php
		if ( have_posts() ) :
