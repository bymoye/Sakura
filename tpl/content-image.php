...
<div class="post-entry">
  <div class="feature">
	<?php if ( has_post_thumbnail() ) { ?>
		<a href="<?php the_permalink();?>"><div class="overlay"><i><svg class="paper" viewBox="0 0 40 40"><use xlink:href="#svg_paper"></use></svg></i></div><?php the_post_thumbnail(); ?></a>
		<?php } else {?>
		<a href="<?php the_permalink();?>"><div class="overlay"><i><svg class="paper" viewBox="0 0 40 40"><use xlink:href="#svg_paper"></use></svg></i></div><img src="<?php bloginfo('template_url'); ?>/images/random/d-<?php echo rand(1,10)?>.jpg" /></a>
		<?php } ?>
	</div>	
	...
	<div class="post-more">
			<a href="<?php the_permalink(); ?>"><svg class="caidan"><use xlink:href="#svg_caidan"/></svg></a>
		</div>
	<div class="info-meta">
       <div class="comnum">  
