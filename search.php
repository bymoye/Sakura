...
get_header(); ?>
		...
		if ( have_posts() ) : ?>
			...
			<header class="page-header">
				<h1 class="page-title"><?php printf( __( 'search result: %s', 'sakura' )/*杜索结果*/, '<span>' . get_search_query() . '</span>' ); ?></h1>
			</header><!-- .page-header -->
			<?php } ?>
			<?php
			/* Start the Loop */
		...
		<!-- search start -->
		<form class="s-search">
		<svg class="search icon-search" viewBox="0 0 40 40" style="position: absolute;width: 24px; bottom: 8px;left: 12px; fill: #ddd;";><use xlink:href="#svg_search"></use></svg>
